...
- 4 GB of RAM or more
- A command line interface (Command Prompt or PowerShell)
...
7. After the download finishes, open the folder where you saved the file.

8. Double-click the `.exe` file to start the game.

9. A terminal window will open with the game running inside it.

## 🎮 How to Play Wilson's Revenge

Use the keyboard to control Wilson and try to survive:

- Use arrow keys to move left or right.
- Press spacebar or another highlighted key to shoot your shotgun.
- Collect power-ups that appear as you run to gain new abilities.
- Dodge cars and avoid hitting enemies too much to keep playing.
- The game ends when Wilson loses all health.

The game screen shows a detailed ASCII-art world with obstacles and enemies. Each run will feel different due to random level elements.

## ⚙️ Settings and Options

You can adjust some settings before or during the game:

- Change terminal window size for comfortable viewing.
- Adjust game speed in the options menu.
- Toggle sound effects on or off through simple commands.
- View help by pressing `h` or typing `help` in the game.

Modifying settings helps you create a better experience based on your preferences.
...
- For better visuals, set your terminal font to a monospace type.
- Use full-screen mode in your terminal for an immersive view.

## 📂 About This Project

This game was built using the Go programming language. It combines simple ASCII art with gameplay inspired by classic endless runners. The goal was to create a fun, fast, and challenging game that runs easily in a terminal.

Topics related to this project include:

- ascii-art graphics  
- command line interface (CLI) games  
- endless runner gameplay  
- roguelike-lite elements  
- terminal user interface (TUI) frameworks  

## 🤝 Contributing

While this guide is for end users, the project is open to contributions from developers. You can help by reporting issues, suggesting game tweaks, or submitting code improvements. Visit the GitHub page to learn more about contributing.

## 📞 Need Help?

If you run into problems, check the GitHub repository's "Issues" section. You can also open a new issue to ask questions or report bugs.
